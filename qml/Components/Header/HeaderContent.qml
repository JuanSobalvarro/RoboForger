    ...
    Row {
        ...
        Item {
            ...
            ToolButton {
                ...
                icon {
                    source: "qrc:/data/icons/minimize.svg"
                    width: 18
                    height: 18
                }
            ...
            ToolButton {
                ...
                icon {
                    ...
                    property url iconMaximize: "qrc:/data/icons/open_full.svg"
                    property url iconNormalize: "qrc:/data/icons/close_full.svg"
            ...
            ToolButton {
                ...
                icon {
                    source: "qrc:/data/icons/cancel.svg"
                    width: 18
                    height: 18
                }
